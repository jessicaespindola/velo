...
export class OrderLockupPage {
    ...
    async validateOrderDetails(order: OrderDetails) { //OrderDetailsExpected tem todos os campos da massa de dados
        // Vantagem de trabalhar com tipagem é que você controla os dados e evita erros no futuq
        // Assert
        const snapshot = `
        - img
        - paragraph: Pedido
